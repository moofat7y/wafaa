...
export default function Projects() {
  const project_list = projects.map((proj, index) => {
    return (
      <div
        data-aos="fade-up"
        class="box p-5 bg-white shadow-sm border duration-300 text-center"
      >
        <h4
          class="date mb-5 w-fit mx-auto border px-2 rounded-2xl bg-primary-500 text-white"
          data-text="date_service_4"
        >
          {proj.date}
        </h4>
        <p
          class="text-[#3A3939] text-lg font-semibold"
  ...
  return (
    <section id="our__works" className="">
